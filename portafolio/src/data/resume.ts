export const resume = {
  ...
  certifications: [
    {
      ...
      organization: "CertiProf International",
      date: "Nov 2022",
      source: "files/ScrumCertificate.pdf",
    },
    {
  ...
  languages: [
    ...
    {
      icon: "images/skills/united-kingdom.png",
      language: "English",
      level: "C1 Level",
    },
  ],
  skills: [
    ...
    {
      icon: "images/skills/sql-server.png",
      name: "SQL Server",
    ...
    {
      icon: "images/skills/handlebars.png",
      name: "Handlebars",
    ...
    {
      icon: "images/skills/dataStructure.png",
      name: "Data Structure",
